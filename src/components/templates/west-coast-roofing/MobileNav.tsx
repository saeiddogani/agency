...
export function MobileNav() {
  ...
  return (
    <div className="md:hidden">
      ...
      {isOpen ? (
        <div id="wcr-mobile-menu" className="fixed inset-x-0 top-[65px] bottom-0 z-40 bg-white">
          <nav aria-label="Mobile" className="flex flex-col px-6 py-8">
            ...
            <a
              href="#contact"
              onClick={() => setIsOpen(false)}
              className="mt-6 rounded-md bg-orange-700 px-5 py-3 text-center text-sm font-semibold text-white"
            >
              Get a Free Estimate
            </a>
          </nav>
