  ...
  return (
    <header id="top" className="sticky top-0 z-50 border-b border-stone-200 bg-white/95 backdrop-blur-sm">
      <div className="mx-auto flex h-18 w-full max-w-[1200px] items-center justify-between px-6 sm:px-8 lg:px-10">
        <a href="#top" className="text-lg font-semibold tracking-tight text-stone-900">
        ...
        <a
          href="#contact"
          className="hidden rounded-full bg-green-800 px-5 py-2.5 text-sm font-semibold text-white hover:bg-green-900 md:inline-flex"
        >
          Request a Quote
        </a>
